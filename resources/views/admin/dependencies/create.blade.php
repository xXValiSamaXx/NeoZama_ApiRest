            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.dependencies.store') }}" method="POST">
                        ...
                        <!-- Name -->
                        <div class="mb-4">
                            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Nombre de la
                                Dependencia:</label>
                        ...
                        <div class="mb-6">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Permisos de Acceso a
                                Categorías:</label>
                            <div class="mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach($categories as $category)
                                    <div class="flex items-center">
                                        <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                                            id="category_{{ $category->id }}" class="mr-2 leading-tight">
                            ...
                            <p class="text-gray-500 text-xs mt-1">Selecciona las categorías cuyos documentos podrá ver
                                esta dependencia.</p>
                        </div>
